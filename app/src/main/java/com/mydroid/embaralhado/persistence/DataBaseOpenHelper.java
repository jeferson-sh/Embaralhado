package com.mydroid.embaralhado.persistence;
...
class DataBaseOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase bd) {
        ...
        bd.execSQL("create table scores(_id integer primary key autoincrement, score int not null, image BLOB not null, user text not null, context_id int not null, answer_count int not null, answer_total int not null);");
